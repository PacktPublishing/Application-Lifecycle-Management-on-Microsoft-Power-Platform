...
namespace Bebe.EarlyBound
{
	...
	public partial class Account : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("msft_datastate")]
		public virtual msft_DataState? msft_DataStateEnum
		{
			get
			{
		...
		public System.Collections.Generic.IEnumerable<Bebe.EarlyBound.Account> Referencedaccount_master_account
		{
			get
			{
				return this.GetRelatedEntities<Bebe.EarlyBound.Account>("account_master_account", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			set
			{
				this.OnPropertyChanging("Referencedaccount_master_account");
				this.SetRelatedEntities<Bebe.EarlyBound.Account>("account_master_account", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
		...
		public System.Collections.Generic.IEnumerable<Bebe.EarlyBound.Account> Referencedaccount_parent_account
		{
			get
			{
				return this.GetRelatedEntities<Bebe.EarlyBound.Account>("account_parent_account", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			set
			{
				this.OnPropertyChanging("Referencedaccount_parent_account");
				this.SetRelatedEntities<Bebe.EarlyBound.Account>("account_parent_account", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
		...
		public System.Collections.Generic.IEnumerable<Bebe.EarlyBound.Account> Referencedmsa_account_managingpartner
		{
			get
			{
				return this.GetRelatedEntities<Bebe.EarlyBound.Account>("msa_account_managingpartner", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			set
			{
				this.OnPropertyChanging("Referencedmsa_account_managingpartner");
				this.SetRelatedEntities<Bebe.EarlyBound.Account>("msa_account_managingpartner", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
		...
		public Bebe.EarlyBound.Account Referencingaccount_master_account
		{
			get
			{
				return this.GetRelatedEntity<Bebe.EarlyBound.Account>("account_master_account", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
		}
		...
		public Bebe.EarlyBound.Account Referencingaccount_parent_account
		{
			get
			{
				return this.GetRelatedEntity<Bebe.EarlyBound.Account>("account_parent_account", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
			set
			{
				this.OnPropertyChanging("Referencingaccount_parent_account");
				this.SetRelatedEntity<Bebe.EarlyBound.Account>("account_parent_account", Microsoft.Xrm.Sdk.EntityRole.Referencing, value);
		...
		public Bebe.EarlyBound.Account Referencingmsa_account_managingpartner
		{
			get
			{
				return this.GetRelatedEntity<Bebe.EarlyBound.Account>("msa_account_managingpartner", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
			set
			{
				this.OnPropertyChanging("Referencingmsa_account_managingpartner");
				this.SetRelatedEntity<Bebe.EarlyBound.Account>("msa_account_managingpartner", Microsoft.Xrm.Sdk.EntityRole.Referencing, value);
