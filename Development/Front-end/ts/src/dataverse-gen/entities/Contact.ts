...
export const contactMetadata = {
  ...
  navigation: {
    ...
    crmk_SSNCountry: ["mscrm.crmk_localizedlanguage"],
...
export const enum ContactAttributes {
  ...
  crmk_SocialSecurityNumber = "crmk_socialsecuritynumber",
  crmk_SSNCountry = "crmk_ssncountry",
  crmk_SSNCountryName = "crmk_ssncountryname",
...
export interface Contact extends IEntity {
  ...
  */
  ...
  /*
  Social Security Number StringType Type the social security number for the contact.
  */
  crmk_socialsecuritynumber?: string | null;
  /*
  SSN Country LookupType Type the country related to the social security number for the contact.
  */
  crmk_ssncountry?: import("dataverse-ify").EntityReference | null;
  /*
   StringType
  */
  crmk_ssncountryname?: string | null;
  /*
